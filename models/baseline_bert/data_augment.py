...
Output
------
  data/augmentation_output/baseline_bert/improved_large_with_tuning/augmentation_candidates.csv  — append to train.csv
  data/augmentation_output/baseline_bert/improved_large_with_tuning/augmentation_report.csv      — human-review report
"""
...
from core.config import IMPROVED_WITH_TUNING_DIAGNOSTIC_ERRORS_PATH
...
# These errors represent genuine failure modes on unseen data and
# are more representative than master_copy errors for targeted augmentation.
ERROR_ROOT_CAUSES_CSV = IMPROVED_WITH_TUNING_DIAGNOSTIC_ERRORS_PATH
...
TRAIN_PATH = Path("data/processed/original/train.csv")
...
EMBEDDING_MODEL = Path(
    "models/baseline_bert/outputs/models/improved_with_tuning"
)
...
OUTPUT_DIR = Path("data/augmentation_output/baseline_bert/improved_large_with_tuning")
...
def load_model_and_tokenizer(model_path: Path, device: str):
    print(f"\n  Loading BERT checkpoint from: {model_path}")
...
def main():
    print("╔══════════════════════════════════════════════════════════════════╗")
    print("║        DATA AUGMENTATION PIPELINE — BERT EDITION              ║")
    print("╚══════════════════════════════════════════════════════════════════╝")
